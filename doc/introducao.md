...
[Olhe o Adianti Tutor 7.6 para ver mais exemplos de tipos de paginas](https://framework.adianti.me//tutor/index.php?class=HomeView&method=onLoad&menu=Presentation&submenu=Pages), um destaque especial para as telas: Formulário multi etapa,  Wizard multi etapa, Páginas internas (inbox)
